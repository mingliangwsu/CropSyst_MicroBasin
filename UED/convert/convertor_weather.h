...
{
 protected:
   Bidirectional_list /*180101 Association_list*/ station_databases;  // This is a list of the UED files created for the stations encountered in the import file.
...
//NYI   void calculate_daily_values();
 ...
 public:
   Convertor_weather(Convertor_arguments/*171120 Convert_response_data_record*/ /*171120 Convertor::Arguments*/ &arguments);                           //170725
...
/*170725  probably obsolete because  Arguments already handles reponse files
 private:
