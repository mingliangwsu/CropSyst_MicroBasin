#ifndef NCDC_ELEMENT_H
#define NCDC_ELEMENT_H

#include <corn/string/strconv.h>

#define Element uint16

extern char *NCDC_element_label_table[];

// The ordering of these elements is alphabetical.
// The order is not otherwise significant.
enum NCDC_element
...
DECLARE_LABELED_ENUM(NCDC_element_labeled,NCDC_element,NCDC_element_label_table);
