...
bool ED_tabular_file_format::Metadata_field::setup_structure(CORN::Data_record &data_rec,bool for_write) modification_
{  bool satup =Parameter_properties_string::setup_structure(data_rec,for_write)  //170808_100124
   ...
   data_rec.expect_nat16("pos",pos,10);                                          //171129
...
{  bool satup = Common_tabular_file_format::Column::setup_structure(data_rec,for_write);
