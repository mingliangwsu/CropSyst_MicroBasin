   ...
   {  //st_file >> in_line;
      ...
      for (int VCi = 0; VCi < element_column_count ; VCi++)
      {
         ...
         else
         {
            ...
            //141025 CORN::Quality_code value_quality = measured_quality;
...
{
   const UED::Geolocation_record * geoloc_record = ued_file_to_export->get_geolocation_record_immutable(); //050429
