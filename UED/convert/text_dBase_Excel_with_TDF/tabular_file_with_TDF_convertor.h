...
: public UED::Convertor // I need to have Tabular_file_with_TDF_convertor_weather
{
 ...
 private: // The following are used for import only
   mutable Bidirectional_list /*180101 Association_list*/ import_columns; // List of UED_import_column  //050404
...
//NYI Milliseconds                 time_step_milliseconds;      //  I dont have this type yet
 ...
 public: // The following are for export only
   Bidirectional_list /*180101 Association_list*/     export_columns;            //070203
 ...
 protected:
   ...
   //171125 nat32 export_opened_UED_file();                                               //141014
   nat32 tuplize_UED_file
      (const CORN::OS::File_name &UED_filename                                   //171125
      ,Tuple_index &export_tuples);                                              //180107
   //171125 nat32 export_UED_file(const CORN::OS::File_name &UED_filename);               //171125
   nat32 export_tuples_for_period(CORN::Container &sorted_tuples);            //150405
   //171125 nat32 export_UED_file_for_period(CORN::Container &sorted_tuples);             //150405
   //171125 nat32 export_UED_file_by_year                                                 //150405
