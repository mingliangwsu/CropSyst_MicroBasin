...
{
 public:
   class Metadata_field : public CORN::Item //180101 Association                               //010814
   ...
   public:
      ...
      nat16      pos;            // for text file this char pos 0 based index
...
public:  // attributes (of ED_tabular_file_format)
   ...
   Bidirectional_list /*180101 Association_list*/ metadata_fields_1based;    // List of Metadata_field. Arbitrary header fields (I think this is scalar fields)
