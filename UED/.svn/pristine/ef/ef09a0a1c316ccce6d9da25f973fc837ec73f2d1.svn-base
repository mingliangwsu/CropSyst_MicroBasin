...
(nat16 column_index // column_number                                                             //020525
...
*/
       ...
       {
          result = tuplize_data(column_index/*column_number*/,data_record,tuples,database,smart_preferred_units/*,true*/
