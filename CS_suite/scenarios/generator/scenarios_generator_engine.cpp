...
//170529#include "corn/datetime/date.hpp"
...
{  Scenario_level *provided = 0;
   ...
   CORN::Item_wstring *primary_scenario_level_name =
      dynamic_cast<CORN::Item_wstring *>(path_list.pop_at_tail());
...
,const CORN::OS::Directory_name  &scenario_to_be_generated)         affirmation_
{
      ...
      ,each_scenario_decoding)
   {
      ...
      FOR_EACH_IN(decoded_element,CORN::Item_string/*180511 Text_list::Item*/,decoded_elements,each_decoded_element)
      {
...
{  const CORN::OS::File_name *most_appropriate_candidate = 0; nat8 mosts_appropriateness = 0;
   ...
   {  CORN::Text_list candidate_path_items;
      ...
      FOR_EACH_IN(appropriate,CORN::Item_wstring/*Text_list::Item*/,appropriates,each_approp)
      {  FOR_EACH_IN(dir_name,CORN::Item_wstring/*Text_list::Item*/,candidate_path_items, each_dir_name)
...
//_2017-05-12__________________________________________________________________/
...
(CORN::Data_source_dBase &DBF_file)                                   provision_
{
   ...
   fields_dBase->ID_field
      = DBF_file.lookup_field(arguments->ID_fieldname.c_str());
         //171111 ("ID");
/*171111 shouldn't be needed because "ID" is now the default
   if (!fields_dBase->ID_field)
      fields_dBase->ID_field = DBF_file.lookup_field("ID");
*/
...
//_2017-05-10__________________________________________DBF_has_a_geocoordinate_/
