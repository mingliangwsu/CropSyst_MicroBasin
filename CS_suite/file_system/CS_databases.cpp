...
::render_most_appropriate_existing_in_any_context_deprecated
...
,CORN::Container       &relevent_database_subdirectories)             rendition_
{
   ...
   FOR_EACH_IN(database_subdir,CORN::OS::Directory_name
              ,relevent_database_subdirectories,each_DB)
   ...
   return extract_most_appropriate_candidate_deprecated(canidate_filenames,appropriates);
}
//_2017-02-02___________________________________________________________________
CORN::OS::File_name *CS::Databases::extract_most_appropriate_candidate_deprecated
...
// essentially given
{
   ...
   for (CORN::OS::File_name *candidate
          = dynamic_cast<CORN::OS::File_name *>(candidates.pop_first())
       ;candidate
   ...
   {  CORN::Text_list candidate_path_items;
      ...
      FOR_EACH_IN(appropriate,CORN::Item_wstring/*CORN::Text_list::Item*/,appropriates,each_approp)
      {  FOR_EACH_IN(dir_name,CORN::Item_wstring /*180115 CORN::Text_list::Item*/,candidate_path_items, each_dir_name)
...
CORN::OS::File_name *CS::Databases
::render_find_most_appropriate_in_any_context_string_deprecated
...
,CORN::Container       &relevent_database_subdirectories)             rendition_
{
   ...
   return extract_most_appropriate_candidate_deprecated(canidate_filenames,appropriates);   //170202
}
//_2016-10-31___________________________________________________________________
} // namespace CS
