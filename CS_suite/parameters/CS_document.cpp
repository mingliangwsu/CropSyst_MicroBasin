...
//160704               key_value_pairs.append(value_mapping);                                               //160703
         ...
         } else
         {
            ...
            KV_pair = new structural::Pair_key_value_concrete(simple_key,value_mapping);
            */
...
: Document()
, common_parameters(_associated_directory_mode)
{}
//______________________________________________________________________________
structural::Pair_key_value *Document_structured::instanciate_key_value_pair(given_ structural::Construct *key)
{
   return
   ...
   : (structural::Pair_key_value *)0;
}
//______________________________________________________________________________
structural::Pair_key_value *Document_structured::Description::instanciate_key_value_pair(given_ structural::Construct *key)
{  return
...
structural::Pair_key_value *Document_structured::Version::instanciate_key_value_pair(given_ structural::Construct *key)
{
 return
