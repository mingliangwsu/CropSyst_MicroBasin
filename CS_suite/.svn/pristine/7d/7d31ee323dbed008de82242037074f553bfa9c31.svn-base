...
//#define PROCESS_PENULTIMATES
// No longer separating by penultimates

//#define WORKLOAD_MANAGER
// For linux workload manager now using scripts to generate
// list of ultimate scenarios and scheduling using job arrays.
...
class Scenarios_scheduler_engine
{
 ...
 public:
   ...
   nat32 process_penultimates()                                   modification_;
   #endif
   nat32 process_ultimates()                                      modification_;
 protected:
   ...
   #endif
   nat32 list_ultimate_scenarios(CORN::Container &penultimate_scenarios);
