...
// Actually this should be renamed Environment_meteorological
{
 ...
 public:
   ...
   Atmospheric_CO2_change_element *                                              //171207
      ...
      //171207 , const CORN::Date_const &today)                          initialization_; //150315
   ...
   virtual const CS::Solar_irradiance_extraterrestrial
      &ref_solar_irradiance_extraterrestrial()                            const; //151201
