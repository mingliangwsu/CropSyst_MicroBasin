...
{  // Instanciates Database directories found in ancestors of the specified
 ...
 public:
   ...
   CORN::OS::File_name *render_most_appropriate_existing_in_any_context_deprecated          //170202
   ...
   //170512 probably could be generalized to return DEN (file or directory)

   CORN::OS::File_name *render_find_most_appropriate_in_any_context_string_deprecated
      (const std::wstring    &find_extension // can be actual or wildcard
      ,const std::string     &name
      ,const CORN::Text_list &appropriates
      ,CORN::Container       &relevent_database_subdirectories)      rendition_;
 ...
 protected:
   CORN::OS::File_name *extract_most_appropriate_candidate_deprecated                       //170202
