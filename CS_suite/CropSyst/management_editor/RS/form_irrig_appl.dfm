  ...
  object PageControl1: TPageControl
    ...
    object tabsheet_application_conditions: TTabSheet
      ...
      object groupbox_depletion_constraints: TGroupBox
        ...
        TabOrder = 1
        object max_allowable_depletion_editbar: TRNAutoParameterEditBar
        ...
        object depletion_obs_fract_root_depth_edit: TRNAutoParameterEditBar
          AlignWithMargins = True
          Left = 5
          Top = 126
          Width = 490
        ...
        object depletion_observe_depth_editbar: TRNAutoParameterEditBar
          AlignWithMargins = True
          Left = 5
          Top = 98
          Width = 490
      ...
      object editbar_leaf_water_potential: TRNAutoParameterEditBar
        AlignWithMargins = True
        Left = 3
        Top = 53
        Width = 494
    ...
    object TabSheet2: TTabSheet
      ...
      object panel_application_mode: TPanel
        ...
        object application_mode_radiogroup: TRNAutoRadioGroup
          Left = 0
          Top = 0
          Width = 185
          Height = 51
      ...
      object amount_editbar: TRNAutoParameterEditBar
        AlignWithMargins = True
        Left = 3
        Top = 54
        Width = 494
      ...
      object panel_refill: TPanel
        ...
        BevelOuter = bvNone
        TabOrder = 2
        object net_irrigation_mult_editbar: TRNAutoParameterEditBar
          AlignWithMargins = True
          Left = 3
          Top = 31
          Width = 494
        ...
        object max_application_editbar: TRNAutoParameterEditBar
          AlignWithMargins = True
          Left = 3
          Top = 59
          Width = 494
          ...
          Alignment = taLeftJustify
          BevelOuter = bvNone
          Caption = 'Irrigation system maximum application capacity'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 1
        end
        object min_application_editbar: TRNAutoParameterEditBar
          AlignWithMargins = True
          Left = 3
          Top = 87
          Width = 494
          ...
          Alignment = taLeftJustify
          BevelOuter = bvNone
          Caption = 'Irrigation system minimum application capability'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 2
        end
        object refill_point_edit_bar: TRNAutoParameterEditBar
          AlignWithMargins = True
          Left = 3
          Top = 3
          Width = 494
    ...
    object TabSheet3: TTabSheet
      ...
      object salinity_editbar: TRNAutoParameterEditBar
        AlignWithMargins = True
        Left = 3
        Top = 3
        Width = 494
