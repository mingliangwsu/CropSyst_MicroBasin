object tillage_residue_form: Ttillage_residue_form
  ...
  object dust_mulching_checkbox: TAutoCheckBox
    Left = 0
    Top = 24
    Width = 105
    Height = 17
  ...
  object dust_mulch_groupbox: TGroupBox
    ...
    TabOrder = 2
    Visible = False
    object dust_mulch_depth_edit: TAutoFloat32EditBar
      Left = 8
      Top = 16
      Width = 409
      Height = 21
      ...
      AutoScroll = False
      TabOrder = 0
      Description_label = 'Mulching layer depth'
      Units_label = 'cm'
    end
    object dust_mulch_days_edit: TAutoInt16EditBar
      Left = 8
      Top = 40
      Width = 409
      Height = 22
      ...
      ShowHint = True
      TabOrder = 1
      Description_label = 'Number of days until mulch effect subsides'
      Units_label = 'days'
    end
    object dust_mulch_intensity_edit: TAutoFloat32EditBar
      Left = 8
      Top = 64
      Width = 409
      Height = 21
      ...
      ShowHint = True
      TabOrder = 2
      Description_label = 'Dust mulch intensity'
      Units_label = '0-1'
    end
  end
  ...
  object groupbox_oxidation_effect: TGroupBox
    ...
    ShowHint = True
    TabOrder = 4
    object edit_oxidation_effect_sand: TAutoFloat32EditBar
      Left = 2
      Top = 15
      Width = 247
      Height = 21
    ...
    object edit_oxidation_effect_clay: TAutoFloat32EditBar
      Left = 2
      Top = 39
      Width = 247
      Height = 21
