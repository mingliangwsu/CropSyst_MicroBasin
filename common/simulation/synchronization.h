...
: public CORN::Date_clad_32
{
 ...
 public:
   ...
   //170524 void set(const CORN::Date &new_date)  modification_;//990317
   virtual CORN::datetime64 set(const CORN::Date_const &new_date)  assignation_; //170524
