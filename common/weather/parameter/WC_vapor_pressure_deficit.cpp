...
{  
   //float64 VPD_max_fromT,VPD_max_fromRH,VPD_max_fromDP;
   ...
   //std::clog << "\tVPD_max_fromT:" << VPD_max_fromT
   //          << "\tVPD_max_fromRH:" << VPD_max_fromRH
   //          << "\tVPD_max_fromDP:" << VPD_max_fromDP
   //          << "\n";
...
float64 Vapor_pressure_deficit_daytime_calculator::estimate_from_VPD_max(Quality &quality) const
{
   ...
   //std::clog << "VPD_max:" <<  VPD_max << "\tVPD_daytime:" << VPD_daytime << std::endl;
