...
extern bool load_NCDC_stations(CORN::Bidirectional_list /*180101 Association_list*/ &locations);
extern bool load_WBAN_stations(CORN::Bidirectional_list /*180101 Association_list*/ &locations);
#endif
