...
: Relative_humidity_extreme_calculator(_value,  _quality)
...
, precipitation(_precipitation)                                                  //100215
{}
//_Relative_humidity_maximum_calculator_constructor_____________________________
Relative_humidity_maximum_calculator::Relative_humidity_maximum_calculator                                          //180810
...
//_Relative_humidity_maximum_calculator_constructor_________________2018-08-10_/
   ...
   {  if (updating)                                                              //081027
      ...
      {  updating = true;                                                        //081027
         ...
         {  RHmax = calc_from_humidity_specific(RHmax_quality);                  //180813
            //180813 RHmax_quality.assume_code(CORN::calculated_quality);                            //180811
...
/*abandoned
float64 Relative_humidity_maximum_calculator::get_VP_sat()                 const
{
   float64 Tmin = air_temperature_min->get_value_update_if_necessary();
   return calc_saturation_kPa(Tmin,Tmin,false);
}
//__________________________________________________________________2018-08-10_/
*/
      ...
      {  updating = true;                                                        //081027
         ...
         {  // we may be able to get better data
               ...
               {  RHmin =calc_from_humidity_specific(RHmin_quality);             //180811
                  //180803 RHmin_quality.assume_code(CORN::calculated_quality);                            //180811
