...
{
public:
   CORN::Date_const        &Ytoday;
protected:
   const CORN::Date_const  &start_date;  // These are references the dates stored in the user parameter
   const CORN::Date_const  &stop_date;                                           //101221
...
public:
   ...
   **/
public: // accessor
   inline const CORN::Date_const &get_today()             const {return Ytoday;}
public:
...
public: // The following are for working with event lists
   ...
   virtual nat16  synchronize
      ...
      ,const CORN::Date_const &date_to_synchronize_to
      ,void *associated_object = 0)                               modification_;
      // we can optionally syncronized only if the associated object matches
