...
: Simulation_element_abstract(today_raw_)                                        //180402
...
, Tmax_yesterday(0)
{
   ...
   /*170327
   if (substitute_year_base_)                                                    //170323
      database_file->enable_substitute_dates
      (substitute_year_base_                                                     //170323
      ,substitute_year_offset_                                                   //161207
      ,preclude_available_weather_date_                                          //170310
...
, provider(0)
//180402, today_raw(today_raw_)                                                          //170525
, today_override_raw(0)
, Tmax_yesterday(0)
{
...
bool Weather_database_daily_UED::start_day()                       modification_
{
   ...
   UED::Time_query_single_date time_qry
      (today_override_raw ? today_override_raw : today_raw                       //17025
...
*/
   ...
   CORN::Date_clad_32 provided_date_tomorrow(today_override_raw ? today_override_raw : today_raw);
...
(modifiable_ Geocoordinate &geocoordinate)                                 const
{
   const UED::Geolocation_record  *geoloc
      = database_file->get_geolocation_record_immutable();
...
//______________________________________________________________override_today_/
} // namespace CS
