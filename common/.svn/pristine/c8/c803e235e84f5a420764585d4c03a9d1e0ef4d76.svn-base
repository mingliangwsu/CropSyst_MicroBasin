...
: public extends_ Relative_humidity_calculator
{
 ...
 public: // structors
   ...
   inline Relative_humidity_extreme_calculator
      ...
      {}
 public:
   float64 calc_from_humidity_specific(CORN::Quality &RHmax_quality)      const;
/*abanonded
 private:
   virtual float64 get_VP_sat()                                         const=0;
*/
 private:
...
: public Relative_humidity_extreme_calculator  //180810Relative_humidity_calculator  //140220
...
//abandoned   virtual float64 get_VP_sat()                                           const; //180808
};
//______________________________________________________________________________
class Relative_humidity_minimum_calculator
: public Relative_humidity_extreme_calculator  //180810 Relative_humidity_calculator
...
//abanonded  virtual float64 get_VP_sat()                                           const; //180808
};
#endif
//______________________________________________________________________________
