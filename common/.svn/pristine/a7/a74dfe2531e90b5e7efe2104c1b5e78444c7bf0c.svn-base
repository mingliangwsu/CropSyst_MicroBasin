...
{  for (int i = 0; i < ET_Model_COUNT; i++)
   {
      ...
      /*180404 using invalidate
      ET_ref[i].set_mm(0.0,CORN::unknown_quality);                               //180404
      set_mm(0.0,CORN::unknown_quality);                                         //180404
      */
      /*180404
...
//______________________________________________________________________________
//180822 void
const CORN::Quality &     //180822
ET_Reference_FAO::update()  rectification_
...
//100420 now references to parameters are provided directly rather than having and entire weather object
   ...
   //180404 ET_ref_quality[ET_FAO_56_Penman_Monteith_CropSyst] = PM_quality.get_quality_code();//150805
         ...
         && PM_quality.is_valid())                                               //150805_020401
   {
      ...
      float64 extra_terrestrial_radiation_MJ_m2   // This should be daily derived from hourly when available
          = solar_irradiance_extraterrestrial.get_MJ_per_m2_day();               //150625
      ...
      ET_hargreaves_unadjusted_quality
         //180404 = ET_ref_quality[ET_Hargreaves_adjusted]
