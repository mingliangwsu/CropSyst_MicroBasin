...
,const CS::Solar_irradiance_extraterrestrial &solar_irradiance_extraterrestrial_ //150625
...
, solar_irradiance_extraterrestrial         (solar_irradiance_extraterrestrial_) //150625
...
{  // Net outgoing longwave radiation  MJ/(m day)
   ...
   // Determine the factor applied to Stefan_Boltzmann_law depending on available data
   {
      ...
      float64 Ra  // MJ/m2  (per day)                                            //011008
         = solar_irradiance_extraterrestrial.get_MJ_per_m2_day();
...
void ET_common::dump_detail(std::ofstream &strm)
{
   strm
        ...
        << "\t"<< solar_irradiance_extraterrestrial.get_MJ_per_m2_day()          //150827
