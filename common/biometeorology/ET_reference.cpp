...
//DOY = TimeState.DayOfYear
   ...
   float64 Pot_Rad = 0.0;
   Pot_Rad = solar_irradiance_extraterrestrial/*180822 ET_solar_irradiance*/.get_MJ_per_m2_day();                        //150626
...
::calc_Hargreaves_unadjusted(CORN::Quality &quality)                       const
{
   ...
   irradiance_extraterrestrial = solar_irradiance_extraterrestrial.get_MJ_per_m2_day(); //150626_110414_101206
