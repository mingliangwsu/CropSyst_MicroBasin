...
bool File_system_engine_Windows::browse_directory
...
//_2008-09-29________________________________________________browse_directory__/
bool File_system_engine_Windows::edit_file(const File_name &file_name)     const
{  ///< Edit the file with a suitable  associated program.
   return (int) ShellExecuteW(0,L"edit",file_name.w_str(),NULL,NULL,SW_SHOW)>32;//090615
      // If ShellExectute return value > 32 it succeeded
}
//__________________________________________________________________edit_file__/
bool File_system_engine_Windows::view_file  (const File_name &file_name)   const
{  return invoke(file_name,"open");
}
//__________________________________________________________________view_file__/
bool File_system_engine_Windows::print_file (const File_name &file_name)   const
{  HINSTANCE hInst = ShellExecuteW
  (0,L"print",file_name.w_str(),NULL,NULL,SW_SHOWNORMAL);                        //001109
  return ((int)hInst > 32);
}
//__________________________________________________________________print_file__/
bool File_system_engine_Windows::open_file  (const File_name &file_name)   const
{  return (int)ShellExecuteW(0,L"open",file_name.w_str(),NULL,NULL,SW_SHOW)>32;  //090615
}
//__________________________________________________________________open_file__/
int File_system_engine_Windows::invoke(const File_name &file_name,const char *shell_open_mode) const
{  int exit_status = EXIT_FAILURE;                                               //090624
   ...
   CORN_string params("");
   if (contains(".htm")||contains(".HTM")|contains(".html")||contains(".HTML"))  //971124
...
//_2006-09-07__________________________________________________________invoke__/
#ifndef _QT_
...
//_2016-10-29___________________________________________________________________
#endif
...
(const Directory_name &directory_name
//180321 used provide directory in this case ,bool create_parents_as_needed
)                                            const //130126
{
   /*180321
   File_system_engine_common::create_directory
      (directory_name
      //180321 ,create_parents_as_needed
      );                                 //120522
   */
//std::clog << "Creating:" <<directory_name.c_str() << std::endl;
   bool created = CreateDirectoryW(directory_name.w_str(),0);                    //180321

if (!created)
{
std::cerr << directory_name.c_str() << std::endl;
if (GetLastError() == ERROR_ALREADY_EXISTS)     //180321
std::cerr << "already exists" << std::endl;
else
std::cerr << "create error:" << GetLastError() << std::endl;
};

   return created;                                                               //180321
//180321    return CreateDirectoryW(directory_name.w_str(),0) != 0;
}
//____________________________________________________________create_directory_/
...
//______________________________________________________________create_short_cut
...
//_2011-12-12__________________________________________render_resolved_shortcut/
...
//_2011-12-12_______________________render_resolved_shortcut_or_assume_actual__/
...
return false;
   ...
   return
      ...
      : CreateHardLinkW
         (link_name.w_str()   // __in LPCTSTR lpFileName,
         ,file_name.w_str()   // __in LPCTSTR lpExistingFileName,
         ,NULL                //__reserved  LPSECURITY_ATTRIBUTES lpSecurityAttributes (must be NULL)
         );
#endif
}
//______________________________________________________________________________
...
//_2013-02-15___________________________________________________________________
...
//_2017-12-15_____________________________________________________________move_/
/*conceptual
...
bool File_system_engine_Windows::set_current_working_directory(const Directory_name &dir_name) const
...
//_2012-10-01______________________________________________is_symbolic_link()__/
...
//_2012-10-01_________________________dereference_symbolic_link_or_shortcut()__/
nat32 File_system_engine_Windows::get_file_size_bytes(const File_name &file_name)   const
{  struct _stat filestatus;
   _wstat( file_name.w_str(), &filestatus );
   return filestatus.st_size;
}
//_2012-11-01____________________________________open_file_with_CORN_file_name__/
...
//_2012-05-29____________________render_resolved_absolute_directory_entry_name_/
#endif
