...
: public Data_source_abstract // 170213 Data_source  // May want to derive this from Data_table
{  class Fielded_sheet : public Item //180101 Association
   {  CORN::Workbook::Sheet *sheet;  // owned by workbook
    ...
    public:
      ...
      inline virtual const char *get_key()     const { return sheet->get_key();}  replace with is_key
      inline CORN::Workbook::Sheet *get_sheet()                  {return sheet;}
   };
protected:  // The following values are used when
   CORN::Workbook  *workbook;
   Bidirectional_list /*180101 Association_list*/  fielded_sheets;
   // Cell location constants for all referenced sheets
