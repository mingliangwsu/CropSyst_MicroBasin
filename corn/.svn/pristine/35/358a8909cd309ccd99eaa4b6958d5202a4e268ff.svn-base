...
//    nat32   fixed_layout_size; just use length field
   ...
   inline virtual bool in_memory() const
   { return Xin_memory; };
 public:
    BIFF_record
...
public:
   ...
   (bool          builtin
   ,nat16        _ixfe
   ,Builtin_style _istyBuiltIn
   ,nat8         _iLevel = 0xFF // ignroed
   )
   : BIFF_record(BIFF34578_CODE_STYLE,6,&body)
   {
      body.ixfe = (nat16)(builtin << 15) | _ixfe;
      body.istyBuiltIn = (nat8)_istyBuiltIn;
      body.iLevel = _iLevel;
   };
};
//______________________________________________________________________________
