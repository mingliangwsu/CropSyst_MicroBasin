...
public: // queries
   ...
   virtual bool has_relative_path()                                       const;
      /**<  \return true if there is a path and it is relative (or partial).
      **/
   bool is_extension_ASCII(const_ASCIIZ valid_ext,bool case_insensitive=false) affirmation_; //170224
...
//___________________________________________ Directory_entry_name_concrete __/
} } // namespace CORN OS

//#define CORN_File_name_instance        CORN::OS::File_name_concrete
//#define CORN_Directory_name_instance   CORN::OS::Directory_name_concrete
#endif
