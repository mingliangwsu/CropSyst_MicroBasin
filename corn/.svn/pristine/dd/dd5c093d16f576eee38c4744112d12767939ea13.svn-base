...
*/
//_get_key__________________________________________________________2003-01-09_/
...
//_browse___________________________________________________________2008-09-29_/
...
{  File_system::Directory *found_directory =
      ...
      (arbitrary_directories.find_cstr(directory_name.c_str()/*180820 .get_key()*/));
   if (!found_directory)
