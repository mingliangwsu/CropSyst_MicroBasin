...
//180101 #include "corn/container/association.h"
...
{
protected:
   Bidirectional_list /*180101 Association_list*/ sheets;        // move this to implementing classes
      // Now should be able to use Unidirectional_list
public:
   class Sheet  : public Item //Association
   {
   public:
      Sheet() {}
...
//NYI      uint8       get_index() = 0;  // the sheet tab index (0 based).
      virtual const char *get_key()                                     const=0;  replace with is_key()
