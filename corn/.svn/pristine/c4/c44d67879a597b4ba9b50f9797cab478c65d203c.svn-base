...
public: // The following get from the time part
   ...
   inline virtual Hours get_hours()                           const { return 0;} //170523
   inline virtual Minutes get_minutes()                       const { return 0;} //170523
   inline virtual Seconds get_seconds()                       const { return 0;} //170523
