...
public:
   ...
   {  if ((index >= current_size_plus_overage) || empty_list)                    //081030
      ...
      //161222 resize sets changed = true;
   ...
   inline virtual void clear()                       modification_
   {
         array_sum = 0;
         terminal_index = 0;
         empty_list = true;
...
/*
         delete[] array;
         array = new T[current_size_plus_overage];
         terminal_index = current_size_plus_overage
            ? (nat32)(current_size_plus_overage - 1) : (nat32)0;
         empty_list =  terminal_index < 0;
*/
