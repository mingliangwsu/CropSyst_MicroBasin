...
//_class VV_enumerated_section______________________________________1997-09-29_/
...
//_class VV_container_enumerated_section____________________________1997-09-29_/
...
#define  expect_uint8  expect_nat8
   ...
   VV_date_entry       *expect_date      (const char *key, modifiable_ Date_clad_32      &value,bool formatted=false,Phrase_label _annotation1=OPTIONAL_PHRASE,Phrase_label _annotation2=OPTIONAL_PHRASE); //050412
   VV_datetime64_entry *expect_datetime64(const char *key, modifiable_ Date_time_clad_64 &value,bool formatted=false,Phrase_label _annotation1=OPTIONAL_PHRASE,Phrase_label _annotation2=OPTIONAL_PHRASE); //050412
   ...
   VV_units_entry      *expect_units     (const char *_key, modifiable_ Units_clad     &_units); // annotation not needed for units, will also confuse parser            //050413
      ...
      **/
 protected:
  void expect_valid_number(const Valid_number &v_number,Bidirectional_list /*180101 Association_list*/ &section_entries);  //040414
 public:
 ...
 public: // While these methods exist in Data_record, but they would not work for dBase files if the section_label,variable_code if very long
   ...
   void expect_int32_array    (const char *_variable_or_section_label, int32 *array     , bool one_based , nat16 max_index, bool enumerate_variable=false);                                               //000926
...
//   VV_Section *set_current_enumerated_section(const char *new_current_section);    //120314
   ...
   inline virtual bool get_modified()                                      const { return modified; } //deprecated, use is_modified()
...
private: // classes
   ...
   {public:
    ...
    public:
      ...
      //180820 virtual const char *get_key() const;                                       //030119
   ...
   //_class Units_label_item___________________________________________________/
   ...
   //_class Units_code_item________________________________________2007-04-04__/
};
//_class Data_record___________________________________________________________/
} // namespace CORN
#endif
//datarec
