...
//______________________________________________________________________________
extern std::string &append_float32_to_string(float32 value,nat8 decimals,std::string &to_string); //131213
extern std::string &append_float64_to_string(float64 value,nat8 decimals,std::string &to_string); //140615
