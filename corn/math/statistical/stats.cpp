...
Statistical_baseX::Statistical_baseX()
: status(0)
, minimum( 999999999.9)
, maximum(-999999999.9)
, mean(0)
...
//______________________________________________________________________________
float32 Statistical_baseX::append(float32 value)                    modification_
{  current = value ;
   return current;
}
//_2004-08-12___________________________________________________________________
void Statistical_baseX::append_dataset
...
Statistical_data_setX::Statistical_data_setX()
: Dynamic_array<float32>(0,30,0)
,coefficient_of_variation(0)                                                     //070710
,median(0)                                                                       //070710
{ reset();}                                                                      //050705
//______________________________________________________________________________
Statistical_data_setX::Statistical_data_setX(const Dynamic_array<float32> &data_to_copy)
: Dynamic_array<float32>(data_to_copy)
,coefficient_of_variation(0)                                                     //070710
,median(0)                                                                       //070710
{ reset();}                                                                      //050705
//______________________________________________________________________________
bool Statistical_data_setX::reset()                                               //150825
{  coefficient_of_variation = 0.0;
   median = 0.0;
   return Statistical_baseX::reset();
}
//_2004-01-23___________________________________________________________________
float32 Statistical_data_setX::get_probability_value(float percentage) provision_
{ float d_prob;
  float d_value;
  float prob;
#define       zero_base_correction -1
   Statistical_data_setX sorted(*this);                                           //061020
...
//______________________________________________________________________________
float64 Statistical_data_setX::get_weighted_value(int at_i)                 const
{  float64 sum = get_sum();
...
float32 Statistical_data_setX::calc_median()                                const
{  Statistical_data_setX sorted(*this);                                           //061020
...
float32 Statistical_data_setX::get_median()                            provision_
...
//_2001-04-06___________________________________________________________________
float32 Statistical_data_setX::get_mean()                                   const
{  if (changed) { Statistical_data_setX *not_const_this = const_cast<Statistical_data_setX *>(this);
      not_const_this->recompute(); }
   return mean;
}
//______________________________________________________________________________
float32 Statistical_data_setX::get_coefficient_of_variation()          provision_
{  if (changed) { Statistical_data_setX *not_const_this = const_cast<Statistical_data_setX *>(this);
      not_const_this->recompute(); }
   return coefficient_of_variation;
}
//______________________________________________________________________________
float32 Statistical_data_setX::get_standard_deviation()                provision_
{  if (changed) { Statistical_data_setX *not_const_this = const_cast<Statistical_data_setX *>(this);
      not_const_this->recompute(); }
   return standard_deviation;
}
//______________________________________________________________________________
void Statistical_data_setX::recompute()                             modification_
{
...
float32 Statistical_data_setX::bisection_method(float32 alpha_initial)      const
...
float32 Statistical_data_setX::Weibull_f(float32 alpha)                     const
{  nat32 n = get_count();
   float64 sum_q = 0;
   float64 sum_r = 0;
   float64 sum_s = 0;
...
//_1998-03-18___________________________________________________________________
void Statistical_data_setX::get_Weibull_alpha_beta
...
//_1998-03-18___________________________________________________________________
///////////////////////////////////////////////////////////////////////////////
float32 Statistical_data_setX::append(float32 value)
{  Dynamic_array<float32>::append(value);
   return Statistical_baseX::append(value);
}
//_2004-08-12___________________________________________________________________
...
{  status_clear_all();
   Statistical_baseX::append(value);                                              //040812
   count++;
   summation += value;
...
//_2009-10-02___________________________________________________________________
Statistical_running_indexX::Statistical_running_indexX(nat16 _applicable)
: Statistical_sample_cumulative<float32,float32>(_applicable)                    //160803
//160803 : Statistical_running_tally()
, index(0.0)
{ current = 1.0; }                                                               //040812
//______________________________________________________________________________
float32 Statistical_running_indexX::append(float32 value)
{
   //160803 Statistical_running_tally
...
//______________________________________________________________________________
bool Statistical_running_indexX::reset()                                          //150825
{  current = 1.0;
   index = 0.0;
   return
      //160803 Statistical_running_tally
