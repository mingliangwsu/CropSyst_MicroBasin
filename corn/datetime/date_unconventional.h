...
{public:
 ...
 public:
   ...
   Date_unconventional(const CORN::Date_time &copy_from,Calendar _calendar);
   ...
   virtual nat32 days_between(const Date_time &that,bool inclusive=false)  const;
};
