...
{  inline Data_stream(){}
   ...
   inline virtual bool reset()                      stream_IO_ { return false; } //141210  = 0;//111113
...
: public File_data_stream
{
 ...
 protected:
   ...
   inline virtual bool deallocate()                                 performs_IO_ //150505
...
: public File_data_stream
{
 ...
 public:
  ...
  protected:
   ...
   virtual bool good()                const { return raw_data_ostream->good(); } //110822
   inline virtual bool deallocate()                                 performs_IO_ //150505
...
//______________________________________________________________________________
//170327 Tabular_format_text_file should be obsolete now because now format
// is through Common_tabular_file_format
struct Tabular_format_text_file_deprecated
...
{
 private:
   const CORN::Common_tabular_file_format &format;                                     //170327
...
*/
   ...
   inline virtual bool reset()                                        stream_IO_
      { return data_stream ? data_stream->reset() : false; }                     //111111
   ...
   //170424 replaced with label_string virtual const char *label_cstr_deprecated(char *buffer)                const;
...
public:
   ...
   inline virtual Relative_to get_relative_to_labeled()                    const //060823
      { return format.relative_to_labeled.get(); }
   inline virtual int get_start_data_row_1_based()                         const
      { return format.detail_lines_delineation.start_row_1_based; }                    //171110
      //171100 { return  format.start_row_1_based;} //010815
 ...
 protected: // The following methods apply to writing files (overrides Tabular_file);
   ...
   virtual nat32 write_field_string
      (const char *c_str,CORN::Delineation_layout::Text_quote_mode quote_mode);  //070203
 public:
