...
public: // Item reimplementation
      //170424 replaced with label_string virtual const char *label_cstr(char *buffer)                const;  // probably return unqualified workbook name or the fully qualified filename
