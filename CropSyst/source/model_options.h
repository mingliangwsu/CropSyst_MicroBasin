...
class CropSyst_Model_options
{
 ...
 public:  // submodel options
   ...
   /*170808 replaced by Priestley_Taylor_alpha_fraction
   float32    Priestley_Taylor_constant;
      Parameter_number *p_Priestley_Taylor_constant;                             //170604
   */
//130528
   Transpiration_model_labeled               transpiration_model_labeled;        //050331
   //170808  float32 Priestley_Taylor_alpha_fract;                                         //170808
 ...
 public: // CO2
   ...
   //171207 deprecated #if ((((CS_VERSION >= 1) && (CS_VERSION < 5)) && !defined(REACCH_VERSION)) || defined(LIU_ENGINE))
