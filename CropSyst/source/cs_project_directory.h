...
// not needed for LADSS/*050202*/ public: // GIS model
   CORN::OS::File_name_concrete    GIS_dir_qual;                                   //050203
   CORN::OS::File_name_concrete    GIS_aggregation_dir_qual;                       //050930
 ...
 public:                                                                         //040810
   const CORN::OS::File_name_concrete &get_GIS_dir_qual             (bool create_if_necessary) const; //040810
   const CORN::OS::File_name_concrete &get_GIS_aggregation_dir_qual (bool create_if_necessary) const; //050930
 ...
 private: // Carbon sequestration files/folders               
   CORN::OS::File_name_concrete carbon_sequestration_optimization_dir_qual;        //020426
 public:                                                                         //040810
          const CORN::OS::File_name_concrete &get_carbon_sequestration_optimization_dir_qual(bool create_if_necessary) const;
 ...
 private: // scenario_comparision folders                                        //070423
   CORN::OS::File_name_concrete    scenario_comparison_dir_qual;                   //050930
 public:                                                                         //070423
   const CORN::OS::File_name_concrete &get_scenario_comparison_dir_qual
