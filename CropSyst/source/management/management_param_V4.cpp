...
//_1998-10-07_____________________________________________________________________________
...
//1998-10-07___________________________________________________________________
...
const char *Residue_operation::label_cstr(char *result)         const
...
//110104 moved to org_N_op_abstract ,org_N_source_labeled      (SWINE)           //020322
...
//_2002-03-22______________________________________________________is_liquid()_/
void Organic_nitrogen_operation::setup_parameters(CORN::Data_record &data_rec,bool for_write)
{
   ...
   data_rec.expect_bool(LABEL_org_N_volatilization_calculated,org_N_volatilization_calculated,CROPSYST_VV_BOOL_FORM);   //020525x
   data_rec.expect_enum(LABEL_liquid,solid_liquid_form_labeled);                 //020322
}
//_1998-12-28_________________________________________________setup_parameters_/
/*170426 replaced with label_string
const char *Organic_nitrogen_operation::label_cstr(char *result) const
...
//_1998-12-28_______________________________________________________label_cstr_/
*/
...
//_2017-04-23_____________________________________________________label_string_/
void Organic_nitrogen_operation::log(std::ostream &log_file) const
{  Organic_nitrogen_operation_abstract::log(log_file);                           //080902
   char buffer[255];                                                             //030123
   log_file << LABEL_org_N_source << '=' << organic_matter_source_cowl.get_label() << std::endl;  //021105
   ...
   log_file << "form" << '=' << solid_liquid_form_labeled.get_label() << std::endl; //021105
}
//_20??-??-??______________________________________________________________log_/
#endif
...
//_2002-03-14_________________________________________________setup_parameters_/

// Warning, not sure why I moved log here and not to '_class
void Auto_clip_biomass_mode::log(std::ostream &log_file) const
{
//120502   Harvest_or_clipping_operation/*120501 Auto_clip_biomass_mode_class*/::log(log_file);
...
,v_surface_evaporation_area_fraction (soil_wetting.surface_evaporation_area_fraction,UC_fraction,"surface_evaporation_area",3,1.0,0.0,1.0,0.0,1.0,"fraction","Soil surface subject to soil evaporation") \
,v_profile_volume_fraction           (soil_wetting.profile_volume_fraction          ,UC_fraction,"profile_volume"          ,3,1.0,0.0,1.0,0.0,1.0,"fraction","Soil profile volume")
...
//_1998-10-07___________________________Irrigation_operation::setup_parameters_/
...
//_2012-05-03___________________________Irrigation_operation::setup_parameters_/
...
// g++ compiler is having problems with friendship so prior version importing is not supported in Linux
      ...
      set_current_section("soil_N_sampling");                                                            //040712
         //130426 now completely obsolete expect_enum(LABEL_sync_old,N_application_soil_observation_event->begin_sync.sync_labeled_V3);   //120625 support for V3
...
{  count = MANAGEMENT_PARAMETER_CHANGE_COUNT;
  ...
  nat8 option_version[3] = {  CS_VERSION_NUMBERS };
