...
, const CS::Desired_variables &_desired_vars)                                    //170225
...
bool CS_daily_data_record::expect_structure(bool for_write)
{
   ...
   //170217unused CropSyst::Crop_interfaced *crop = land_unit_sim.crop_active_or_intercrop;     //131008
...
bool CS_daily_data_record::set_start()                                           //161023
{
   ...
   //done above I think we need to output the act root biomass /*041021_*/   crop_root_biomass_kg_m2             = over_ha_to_m2(crop->get_act_root_biomass_kg_ha());
      ...
      crop_canopy_ground_cover            = crop->get_fract_canopy_cover_green(); //180328
         //180328crop->get_fract_canopy_cover_total();
   ...
   ET_ref_m                            = ET_ref->get_m();                        //180416
      //180416 ET_ref->pot_ref_evapotransp_m; /*ref_crop_evapotransp_m;  */        //130723
   #else
...
(UED_variable_code variable_code,nat8 num_sublayers,const char *section
...
,uint8 num_sublayers,Units_code time_stamp_step)
{
