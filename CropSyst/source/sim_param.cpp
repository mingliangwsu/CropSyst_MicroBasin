...
//_1999_______________________________________________initial_chemical_profile_/
...
{  char i_str[10];
   for (int8 i = 0; i <= MAX_soil_horizons; i++)
   {
      ...
      v_chemical[i] =  new Valid_float32(horizon_chemical[i],UC_kg_ha,i_str,3,0.0, 0.0,9999.0,  -0.0001,9999.0 ,TU_kg_ha   );
   };
};
//_1999-02-25_______________________________________________________initialize_/
...
//_20017-04-23____________________________________________________label_string_/
...
{  vv_file.expect_valid_float32(v_half_life_override);
   ...
   vv_file.expect_bool(LABEL_enabled,Xenabled,CROPSYST_VV_BOOL_FORM);
