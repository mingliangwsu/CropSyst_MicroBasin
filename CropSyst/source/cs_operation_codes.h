...
DECLARE_LABELED_ENUM(CropSyst_Op_labeled,CropSyst_Op,CropSyst_operation_codes)
DECLARE_LABELED_ENUM(CropSyst_Op_descriptive_labeled,CropSyst_Op,CropSyst_op_text);
//______________________________________________________________________________
#endif
