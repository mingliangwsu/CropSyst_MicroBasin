...
//______________________________________________________________________________
class Organic_matter_residues_profile_common
...
{protected:                                                                      //070707
   ...
   Soil_abiotic_environment_profile &soil_abiotic_environment_profile;           //060216
 ...
 public:
   Organic_matter_residues_profile_common                                        //070707
      (Soil_interface                     *soil
      ,Soil_abiotic_environment_profile   &soil_abiotic_environment_profile      //160412
 ...
 public: // process
   ...
   virtual bool start_year()                                       modification_;//070510
 ...
 public: // Event processing
   virtual bool respond_to_field_operation                                       //060726
      ...
      ,const Soil_disturbance          *_soil_disturbance
   ...
   virtual const Soil_disturbance *know_soil_disturbance
 ...
 protected: // accessors
   ...
   inline virtual Residues_interface *mod_residues()               modification_ //160627
      { return &residues; }
   //160627 virtual Residues_interface *get_residues() { return &residues; }              //111004
