...
{  // Lists all Organic_biomatter_V4_4 pools (including SOM and residue)
 ...
 protected:
   Organic_biomatter_common *organic_matter[ORGANIC_MATTER_TYPE_COUNT][MAX_soil_layers_alloc];
 ...
 protected: // For process today (by layer)
   ...
   soil_layer_array64(immobilized_NO3_N); // kgN/m3   //170326 renamed from
   soil_layer_array64(immobilized_NH4_N); // kgN/m3   //170326 renamed from
   soil_layer_array64(CO2_C_loss_subsurface_residue_and_OM);// kgC/m3            //060504
      // Used by new denitrification (NO3_with_CO2_Profile)
   soil_layer_array64(CO2_C_loss_subsurface_OM);            // kgC/m3            //080902
      // Used by new denitrification (NO3_with_CO2_Profile)
   soil_layer_array64(CO2_C_loss_subsurface_residue);       // kgC/m3            //080902
      // Used by new denitrification (NO3_with_CO2_Profile)
   soil_layer_array64(N_immobilization_demand_sum_subsurface); // kgN/m3
   soil_layer_array64(mineralized_N_residue);       // kgN/m3 (subsurface)
      // Some models doe not have residue N mineralization
   soil_layer_array64(mineralized_N_OM);           // kgN/m3
   soil_layer_array64(mineralized_N_OM_residue);   // kgC/m3
 ...
 public:
   Organic_matter_pools_common
      (const Organic_matter_decomposition_parameters &OM_decomposition_parameters //120912
      ,Soil_abiotic_environment_profile  &soil_abiotic_environment_profile       //060726
      ,const Soil_layers_interface       &soil_layers                            //060726
      ,const Soil_structure_interface    &soil_structure                         //070725
      ,Soil_nitrogen_interface           *soil_N
...
public:  // Events
   bool respond_to_field_operation                                               //060726
      ...
      ,const Soil_disturbance *_soil_disturbance); // 0 = optional               //060807
   ...
   virtual bool take_OM_pool(Organic_biomatter_common_pool *OM_pool) appropriation_;//161116
   virtual bool specialized_reference                                            //170228
      (Organic_biomatter_common_pool *OM_pool_common)                       = 0;
 public:  // Accessors get_total_xxx()
   ...
   virtual Organic_biomatter_common  *render_OM_pool                             //111001
      ...
      , Soil_abiotic_environment_layer * _soil_abiotic_env_layer)   rendition_=0;
   virtual Organic_biomatter_common_pool *render_OM_pool_for_read() rendition_=0;//161116
