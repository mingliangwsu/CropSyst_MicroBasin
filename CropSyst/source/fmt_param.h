...
//             To insure that required output variables have been selected.
   ...
   void list_required_variables(CS::Desired_variables &required_variables) const;//170225_040902
};
//______________________________________________________________________________
...
{public:
   ...
   //170525 CORN::Date     profile_print_date_data[MAX_PRINT_DATES_ALLOC];   // 1 indexed //991105
 ...
 public:
   ...
   void list_required_profile_variable
      (CS::Desired_variables &required_variables,UED_variable_code base_var_code ,int sublayers) const;
   void list_required_variables
      (CS::Desired_variables &required_variables,int sublayers)           const;
