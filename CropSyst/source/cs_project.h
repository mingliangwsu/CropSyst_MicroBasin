...
//180622 #include "common/simulation/simulation.h"
...
namespace CS { class Desired_variables; }                                        //170225_091007
...
{public: // public for parameter editor
 ...
 public:
   ...
   void list_required_variables(CS::Desired_variables &required_variables) const;//091006
   #endif
};
