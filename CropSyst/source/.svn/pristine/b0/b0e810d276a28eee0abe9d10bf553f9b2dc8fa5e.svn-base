...
{
   //161023 moved below CropSyst_project::set_start();                                //140316
...
//_2005-02-04_______________________________________________________set_start__/
bool Project_editor_parameters::get_end()
{
//160123    bool ended = CropSyst_project::get_end();                                     //140309
//    The statistics and probablity selection are packed in a single nat32 for storage in the file
...
bool Project_editor_parameters::expect_structure(bool for_write)
{
   ...
   set_current_section("crop_production_function");                              //030517
      expect_bool("water",CPF_water,CROPSYST_VV_BOOL_FORM);                      //030517
   set_current_section(LABEL_GIS);                                               //990525
      expect_bool(LABEL_subsurface_flow,subsurface_flow,CROPSYST_VV_BOOL_FORM);  //990604
