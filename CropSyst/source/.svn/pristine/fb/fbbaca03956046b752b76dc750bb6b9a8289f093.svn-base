...
//_restart__________________________________________________________1998-07-24_/
bool Crop_interfaced_complete::sow(bool fall_sowing)  // plant_crop
{  bool sowed = Crop_complete::sow(fall_sowing);                                 //140813
   return sowed;
}
//_sow______________________________________________________________2002-02-20_/
...
//_process_biomass_fate_________________________________2007-06-25__2004-06-21_/
...
//_ref_thermal_time_cumulative______________________________________2013-06-13_/
...
//_get_live_green_canopy_biomass_kg_ha_________________________________________/
float64 Crop_interfaced_complete::get_act_root_biomass_kg_ha()             const
{  return over_m2_to_ha * act_root_biomass; }
//_get_act_root_biomass_kg_ha__________________________________________________/
...
//_calc_root_biomass________________________________________________2007-12-15_/
#ifdef CROP_ORCHARD
#ifdef OLD_ORCHARD
//071120
...
//_get_dry_biomass_kg_ha_______________________________________________________/
...
//_get_dry_biomass_kg_ha____________________________________________2007-11-20_/
#endif
#endif
//______________________________________________________________________________
...
//__________________________________________________________________2008-04-29_/
...
//__________________________________________________________________2005-08-22_/
...
//__________________________________________________________________2004-07-19_/
...
//_initiate_emergence__________________________________________________________/
...
//_process_day______________________________________________________2002-07-11_/
#ifdef CROP_ORCHARD
//#error reached
#ifndef OLD_ORCHARD
//#error reached
...
//_process_day______________________________________________________2002-07-11_/
#if (CROPSYST_VERSION==4)
bool Crop_interfaced_complete::setup_structure(CORN::Data_record &data_rec
,bool for_write,const CS::Desired_variables &desired_vars)
{  bool satup = true;
#ifndef REACCH_VERSION
   satup &= Crop_complete::setup_structure(data_rec,for_write,desired_vars); structure_defined = true;
#endif
   return satup;
}
...
//_is_fruit_harvestable_____________________________________________2008-12-04_/
#endif
...
//_know_directed_irrigation_soil_wetting__________________________________2013_/
#endif
RENDER_INSPECTORS_DEFINITION(Crop_interfaced_complete)
{  return Crop_complete::render_inspectors(inspectors,context,instance);
}
//______________________________________________________________________________
