...
{  int32       land_use_ID;  // Essentially the crop ID
 ...
 public:
   ...
   bool get(CropSyst::Crop_parameters &crop);
};
//_2002-06-12___________________________________________________________________
...
{public:
 ...
 public:
   Event_data_record()
      ...
      {};
   virtual bool expect_structure(bool for_write);                                //031012
};
//______________________________________________________________________________
...
{  int32                mgt_ID;
   ...
   public:
      ...
      int16 SCS_code;
   public:
      inline Resource_set_data_record()
       : CORN::Data_record("-")
       , res_set_ID(0)
       , description("")
       , SCS_code(0)
...
: public CORN::Data_record
{
   ...
   //170525 These probably can be raw
   ...
   CORN::Date_clad_32   peak_LAI_date;
 ...
 public:
   LADSS_season_output_data_record                                               //040217
      ...
      ,const CropSyst::Crop_interfaced *crop);                                   //130716
   virtual bool expect_structure(bool for_write = true);                         //981208
};
...
: public CORN::Data_record
{
 ...
 public:
   ...
   virtual bool expect_structure(bool for_write = true);
};
//_2002-09-23___________________________________________________________________
#endif
//ladss.h
