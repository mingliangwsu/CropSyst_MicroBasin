...
( const Crop_parameters_class::Thermal_time    &_parameters                      //110218
...
//______________________________________________________________________________
float64  Thermal_time_common::Vernalization::update_factor
...
float64 Thermal_time_common::calc_photoperiod_factor()              calculation_
{
...
{  float64 photofactor =
   ...
   vernalization_factor = CORN::must_be_between<float64>(vernalization_factor,0.0,1.0);          //160712
...
{  float64 vernalization_factor = 1.0;                                           //111109
   ...
   {  vernalization_factor = vernalization->update_factor
         (temperature_with_est_night.Celcius());                                 //150122_111109
      if (vernalization->is_satisfied())                                         //111109
      { delete vernalization; vernalization = 0; }                               //111109
   }

   growing_degree_day =                                                          //010723
/*151109 replaced hourly resolution with nonlinear
...
//______________________________________________________________________________
/* NYI
float64 Thermal_time_common::update ()                               modification_
{
