...
//   contribute_ float64 biomass_current;                                          //130625
 ...
 public: // structors
   ...
   inline virtual void know_residues(Residues_interface *residues_) { residues = residues_; }  //060531
   ...
   virtual unmodifiable_ Canopy_accumulation &get_canopy_vital()       const =0; //060911
   virtual unmodifiable_ Canopy_accumulation &get_canopy_effete()      const =0; //060911
   ...
   virtual float64 get_biomass_produced(nat8 include_biomass)             const; // All the biomass ever produced  (Warning, this is not including removed biomass!!! probably should rename this to get_biomass_vital_effette) 060601_
...
//NYN/*080818_*/    virtual Canopy_accumulation::Portion &provide_untouchable_portion() = 0;
   ...
   virtual modifiable_ Canopy_growth_portioned::Canopy_accumulation::Portion *
      get_untouchable_portion()                                         const=0; //080818
 protected:
