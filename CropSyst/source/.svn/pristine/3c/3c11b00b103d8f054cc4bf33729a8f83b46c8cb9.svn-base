...
: public extends_interface_ CS::Simulation_element
{
 ...
 public:
   //160627 virtual Residues_interface *get_residues()                                    = 0;
 ...
 public: // The following are for everything
   /*160627 provided by Simulation_element
   virtual bool process_day()                                       modification_= 0; //150611_140507_060116
   virtual bool start_day()                                         modification_= 0; //060817
   virtual bool start_year()                                        modification_= 0; //070510
   */
   virtual const Soil_disturbance *know_soil_disturbance                              //070801
      (const Soil_disturbance *_soil_disturbance)                   modification_= 0; //070801
   virtual bool  read(std::istream &stream)                          performs_IO_= 0; //120912
};
//_2016-06-26___________________________________________________________________
...
, public extends_ CS::Simulation_element_abstract
{
 protected: // These are all pointers/references owned by the soil do not delete
   const Soil_texture_interface     &soil_texture;    // required                //060122
   Soil_nitrogen_interface          *soil_nitrogen;   // optional                //060122
   const Soil_structure_interface   &soil_structure;                             //070725
   const Soil_layers_interface      &soil_layers;     // required                //060122
   const Soil_hydrology_interface   &soil_hydrology;  // required                //060122
