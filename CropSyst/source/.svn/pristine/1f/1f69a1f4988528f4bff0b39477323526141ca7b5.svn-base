...
// Currently these table names will be hardcoded
   std::string LBF_table_name;
   std::string rotation_table_name;
   std::string soil_table_name;
   std::string location_table_name;
   std::string crop_table_name;
#endif
 public:
   LADSS_database_parameters();                                                  //030109
   virtual bool expect_structure(bool for_write);                                //981208
};
