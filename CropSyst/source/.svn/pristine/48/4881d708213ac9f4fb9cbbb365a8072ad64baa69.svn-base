...
bool CropSyst::Soil::setup_structure(Data_record &data_rec,bool for_write,const CS::Desired_variables &desired_vars)
{
   bool satup = Soil_base::setup_structure(data_rec,for_write,desired_vars);
   #ifdef CHEM_PROFILE
...
bool Soil_base::setup_structure
...
bool CropSyst::Soil_runoff_common::setup_structure(Data_record &data_rec,bool    //131101
,const CS::Desired_variables &desired_vars)
...
//______________________________________________________________________________
bool Soil_temperature_profile::setup_structure(Data_record &data_rec,bool
...
//______________________________________________________________________________
#ifdef CHEM_PROFILE
bool Soil_chemicals_profile::setup_structure(Data_record &data_rec,bool /*not used here for_write*/
,const CS::Desired_variables &desired_vars)
...
//______________________________________________________________________________
#ifdef EROSION
bool RUSLE::Soil_erosion::setup_structure(Data_record &data_rec,bool /*not used here for_write*/
,const CS::Desired_variables &desired_vars)                                      //170225
...
#endif
//______________________________________________________________________________
bool CropSyst_ET::setup_structure(Data_record &data_rec,bool /*not used here for_write*/
,const CS::Desired_variables &desired_vars)
{  data_rec.set_current_section("ET");
   if (desired_vars.is_desired(CSVC_weather_ET_ref_time_step_sum))
      ...
      //180404 data_rec.expect_float64("ETref"       ,pot_ref_evapotransp_m        ); //130723
...
#if (CROPSYST_VERSION==4)
bool CropSyst::Crop_complete::setup_structure
...
/*180416
   ...
   if (desired_vars.is_desired(CSVC_crop_base_temperature_stress_factor))        data_rec.expect_float32("tempstress"   ,report_temperature_stress_stats.ref_current());//160803
*/
//NYI/*_______*/    if (desired_vars.is_desired(xxxx))data_rec.expect_float64(,total_stress                    ,"totalstress" ,UED_index                          ,UED_index         );
   if (desired_vars.is_desired(CSVC_crop_base_fract_canopy_cover))               data_rec.expect_float64("canopycover"
      ,canopy_growth->reference_fract_canopy_cover());                           //080801
   ...
   if (desired_vars.is_desired(CSVC_crop_base_transp_act_time_step_sum))         data_rec.expect_float64("transpact"    ,report_transpiration_act_m);
