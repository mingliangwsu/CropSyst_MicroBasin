...
bool Soil_base::end_day()
{
   ...
   //#error obsolete (this whole method can be removed if not used) //180125
...
,const CORN::date32                 &today_)                                     //131001
#ifdef USE_SOIL_PROPERTIES_SUBLAYERS
...
#endif
,CS::Simulation_element_abstract(copy_from.today_raw)                                //150724
...
{
   KNOW_EMANATOR(today,CS_NOT_EPHEMERAL);             //171114
