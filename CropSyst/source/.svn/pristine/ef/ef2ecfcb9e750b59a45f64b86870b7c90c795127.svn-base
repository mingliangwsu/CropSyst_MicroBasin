...
: Organic_matter_residues_profile_abstract(_soil,today_)
...
, residues
   ...
   ,_temperature_air_avg,_wind_speed,today_,0)                                   //111004
...
(std::istream &stream)                                                stream_IO_
{
   ...
   FOR_EACH_IN(OM_pool,Organic_biomatter_common_pool,(*organic_matter_pools_profile_owned), each_org_BM)
   {
...
RENDER_INSPECTORS_DEFINITION(Organic_matter_residues_profile_common)
{
   ...
   if (organic_matter_pools_profile_owned) organic_matter_pools_profile_owned->render_inspectors(inspectors,context,"SOM");
