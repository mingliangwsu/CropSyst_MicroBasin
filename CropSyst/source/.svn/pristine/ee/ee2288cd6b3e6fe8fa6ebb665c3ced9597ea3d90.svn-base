...
: public Cropping_system_simulation                                              //030616
{
   ...
   public:
      inline Detail_denitr_date_range(CORN::date32 _period_start,CORN::date32 _period_end)
         : CORN::Enumeration()
 ...
 public:  //040815       This is special output for Oumarou's carbonsequestration and grazing regimens model
   ...
   CORN::Statistical_sample_with_dataset<float32,float32,float32> /*180408 Statistical_data_set*/       seasonal_grazing_stats_kg_ha;             // Record of all seasons                                                //040815
   CORN::Statistical_sample_with_dataset<float32,float32,float32> /*180408 Statistical_data_set*/       seasonal_ungrazed_stats_kg_ha;            // Record of all seasons                                                //040815
   CORN::Statistical_sample_with_dataset<float32,float32,float32> /*180408 Statistical_data_set*/       seasonal_biomass_production_stats_kg_ha;  // Record of all seasons                                                //050107
   CORN::Statistical_sample_with_dataset<float32,float32,float32> /*180408 Statistical_data_set*/       seasonal_grazing_req_stats_kg_ha;         // Record of all seasons                                       //050107
 ...
 public:
   ...
   virtual void record_growing_season(CropSyst::Crop_interfaced &crop_to_output);//030516_131008
 protected:
