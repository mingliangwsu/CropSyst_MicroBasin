...
{public:  // until I provide accessors                                           //020629
   float32 &begin_shoot_growth_deg_day; // alias deg_day_emerge for fruit crops  //020405
 public:  // constructor
   Phenology();
   VIRTUAL_BOOL_SETUP_STRUCTURE;
...
class Harvest     // rename to Yield
: public Crop_parameters_struct::Harvest // rename to Yield
{public:
...
//______________________________________________________________________________
 ...
 #ifdef LIU_XIAO_CROP
   Liu_Xiao::Crop_parameters_struct *parameters_Liu_Xiao;
 #endif
 ...
 public:
   ...
   inline virtual bool is_deciduous()                                     const  { return abscission_labeled.get() == deciduous; }; //150904
...
public:
   ...
   virtual float64 param_RUE_PAR_deprecated       (bool after_WUE_change) const; //110825
