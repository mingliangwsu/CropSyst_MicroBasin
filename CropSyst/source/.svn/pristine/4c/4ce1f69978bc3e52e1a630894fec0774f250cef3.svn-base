...
interface_ Canopy_growth_interface
{
   ...
   virtual float64 update_LAI_for_self_shading_response
      (float32 accum_deg_days)                                  modification_=0;
   virtual float64 know_LWP_yesterday(float64 _LWP_yesterday)      cognition_=0;
   virtual float64 get_PAR_solar_rad_intercepted_green_canopy
      (Normal_crop_event_sequence growth_stage)                         const=0;
   virtual float64 get_global_solar_rad_intercepted_green_canopy
      (Normal_crop_event_sequence  growth_stage)                        const=0;
