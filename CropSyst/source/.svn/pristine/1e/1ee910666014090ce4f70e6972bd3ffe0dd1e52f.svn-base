...
/*170703 obsolete because accessible missing scenario parameter file names are
now handled in preinitialize call to designate_accessible_files.


   // If soil file is not specified, discover it
   context_discovery->reset_missing_with_accessible//170703 find_and_reset_missing_parameter_file_name
...
bool CropSyst_Model::process_day()                                 modification_ //150611RLN
{
   ...
   today_for_debug_output = today_raw;
