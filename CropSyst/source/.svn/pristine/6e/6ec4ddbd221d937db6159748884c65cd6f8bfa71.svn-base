...
//______________________________________________________________________________
void Period_accumulators::accumulate(const CORN::Date_const &today,bool run_nitrogen)
{  Water_balance_accumulators::accumulate(today,run_nitrogen);
   ...
   ref_evapotranspiration     += simulation.ET_ref->get_m();                     //180416
      //180416 pot_ref_evapotransp_m;       //130723
   #else
   #ifndef VIC_CROPSYST_VERSION
...
//170502 #ifdef MICROBASIN_VERSION
      //170503RLN N_nitrification            += soil->chemicals->nitrification_N_E_output[0];  //170331LML
      //170503RLN N_denitrification          += soil->chemicals->denitrification_N_E_output[0];  //170207LML
...
//______________________________________________________________________________
void Water_balance_accumulators::accumulate(const CORN::Date_const & today,bool run_nitrogen)
