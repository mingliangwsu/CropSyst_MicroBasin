...
/*170302 decided not to do this
 public:
   virtual float64 reset_mass(float64 new_mass)                    modification_;//170301
*/
 public: // accessors
 ...
 public:
  virtual void clear_decomposition();
   ...
   virtual void write_header(std::ostream &stream)                   stream_IO_; //170302
   virtual bool write(std::ostream &stream)                          stream_IO_; //170302
   */
