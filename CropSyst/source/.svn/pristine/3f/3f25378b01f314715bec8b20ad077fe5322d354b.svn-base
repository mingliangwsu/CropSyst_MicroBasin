...
,int8    &precision_)
{
   ...
   ET_Reference /*180805 CropSyst_ET*/  &ET_ref = *simulation.ET_ref;            //150811_010202
   ...
   {  CORN::Year year; CORN::Month month; CORN::DOM dom;                         //030912
      ...
      { switch (report_options.sel_var_code[dc])
        ...
        case CSVC_crop_base_tuber_fill_temp_stress_index  : num_value= crop->get_tuber_fill_temperature_stress_index(); break; //{ The only place we show stress as the inverse  //081111
         ...
         case DLY_canopy_ground_cover                  : num_value= crop->get_fract_canopy_cover_green() * 100.0;       break;  // report shows the units a percent not a fraction   //041031 //041031
...
//170106         case DLY_canopy_ground_cover                  : num_value= crop->get_fract_canopy_cover() * 100.0;       break;  // report shows the units a percent not a fraction   //041031 //041031
 ...
 /*TILL*/case DLY_soil_clod_rate                       : if (soil && soil->erosion) num_value= soil->erosion->clod_factor_rate;                  break;
         ...
         case DLY_ET_pot                               : num_value= m_to_mm(simulation.output_pot_crop_evapotransp_m); break; //160601_150811_010910
...
,int8    &precision_)
{
   CropSyst::Crop_interfaced                                                     //131008
      &crop = *simulation.get_crop_at_end_of_seasonX();
   ...
   //obs case /*  4*/ GS_planting_date_YMD            : detail_type = detail_STRING; value_str = crop.get_planting_or_restart_date().as_string(); break;
      ...
      case /*  7*/ GS_grain_filling_date_YMD       : detail_type = detail_STRING;                                                                     //030108
         ...
         if (crop.get_crop_model() == CROPSYST_ORCHARD_MODEL)
            ...
            break;
      //180413 case /*  8*/ GS_peak_LAI_date_YMD            : detail_type = detail_STRING; value_str = crop.get_largest_GAI_date().as_string();        break;      //040211
      case /*  8*/ GS_peak_LAI_date_YMD            : detail_type = detail_STRING; value_str = crop.ref_GAI_max_date().as_string();        break;      //180413 040211
      ...
      case /* 14*/ GS_grain_filling_date_YD        :                                                                  //020809
         ...
         break;
      case /* 15*/ GS_peak_LAI_date_YD             : num_value= crop.ref_GAI_max_date().get_date32() / 1000.0;    break; //040211
      //180416 case /* 15*/ GS_peak_LAI_date_YD             : num_value= crop.get_largest_GAI_date().get_date32() / 1000.0;    break; //040211
