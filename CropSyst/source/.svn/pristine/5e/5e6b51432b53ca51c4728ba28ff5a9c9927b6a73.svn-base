...
: CS::Cycler
   (command_line_options_,ID,false)                                              //160513_160908
...
*/
   ...
   initialized &= CS::Cycler::append(meteorology);
...
#endif
*/
   if (arguments.is_verbose(3)) // program-entry
