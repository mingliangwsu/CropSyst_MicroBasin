...
, public Tillage_operation_struct
{
 ...
 public: // virtual methods
   ...
   inline virtual int32 /*enumXX */ get_type()                            const  //011207
      { return op_labeled.get();/*170605 CS_OP_MGMT_TILLAGE;*/ }                 //170605
};
...
: public /*virtual*/ CropSyst_field_operation_VX   // CropSyst_field_operation may be sufficient 011207
...
{  // The event date is the sampling date.
 public:
   ...
   public: // Overrides
      virtual void setup_parameters(CORN::Data_record &data_rec,bool for_write) modification_;  //970709
      //170426 virtual const char *label_cstr(char *buffer)                         const;//030121
      virtual const char *label_string(std::string &buffer)               const; //170423
      virtual void log(std::ostream &log_file)                            const; //020810
 ...
 public:
   ...
   virtual void setup_parameters(CORN::Data_record &data_rec,bool for_write) modification_; //970709
   //170426 virtual const char *label_cstr(char *result)                            const; //030123
   virtual const char *label_string(std::string &buffer)                  const; //170423
   virtual void log(std::ostream &log_file)                               const; //020810
};
//_2011-01-XX___________________________________________________________________
