...
//_2013-02-07___________________________________________________________________
nat8 Soil_parameters_class::limit_profile_depth(float32 soil_profile_depth_limit)
{
   if (CORN::is_approximately<float32>(soil_profile_depth_limit,0.0))
      return number_horizons;
   ...
   {  float32 limited_horizon_thickness_curr = (float32)get_horizon_thickness(limited_horizon);
      ...
      number_horizons = limited_horizon;
   }
   return number_horizons;
}
//_2017-06-09___________________________________________________________________
namespace version4
{
//______________________________________________________________________________
Soil_parameters_class::Soil_parameters_class()
...
//_2017-06-09____________________________________________set_horizon_thickness_/
}
//______________________________________________________________________________
