...
//180101 unused   contribute_ Crop_interfaced *crop_at_harvest;         // crop that was harvested today    //070227 //131008NS
   contribute_ Crop_interfaced *crop_at_end_season;                              //070227_131008
//180101   contribute_ Crop_interfaced *crop_terminated;                                 //070227_131008
...
//   Directed_irrigation_soil_wetting *Xsoil_wetting;  /* optional, owned*/      //130313
 ...
 public: // constructors
   Land_unit_simulation_VX
      ...
      ,CropSyst::Scenario           &scenario_control_and_model_options          //130827
      ,const CORN::date32           &today                                       //130619
...
//180101      #endif
 ...
 public: // operations
   ...
   virtual bool end_operation_period(Common_operation &op, const CORN::Date_const &date_period_ends) ;//020504
...
//   virtual void trigger_synchronization(Normal_crop_event_sequence event,const Crop_interfaced &tiggering_crop);  //130902
   ...
   inline CropSyst::Crop_interfaced *get_crop_at_end_of_seasonX()         const  //070227  // dont' return const crop because we may adjust the biomatter fate //131008NS
       { return crop_at_end_season;}
