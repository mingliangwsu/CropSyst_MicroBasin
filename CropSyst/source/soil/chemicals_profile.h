...
: public Soil_nitrogen_common // was Soil_chemicals_profile_interface              070725
{
 ...
 public:                                                                         //130925
   CORN::Bidirectional_list /*170425 Association_list*/ chemical_profiles;      //170425_980731
 protected:
...
// replaced by Soil_interface  get_NO3_N_mass_kg_m2 and  get_NH4_N_mass_kg_m2
   ...
   float64 sum_NO3_to_depth                                                      //990208
      ...
      ,bool    elemental)                                                 const; //990208
   float64 sum_NH4_to_depth                                                      //120710
      (float64 a_given_depth                                                     //120710
      ,bool    elemental)                                                 const; //120710
   float64 sum_N_to_depth                                                        //170630
      (float64 a_given_depth)                                             const; //170630
   bool is_below_critical_N                                                      //170630
      (float64 critical_N_kg_m2                                                  //170630
      ,float64 sampling_depth)                                     affirmation_; //170630
   ...
   bool setup_structure
      ...
      ,const CS::Desired_variables &desired_vars);                               //030801
