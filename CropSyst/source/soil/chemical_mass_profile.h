...
interface_ Chemical_mass_profile_interface
{
   ...
   virtual bool initialize(soil_layer_array64(init_mass_by_layer))initialization_= 0;
...
: public Chemical_mass_profile_interface
{
 ...
 public:
   ...
   inline virtual float64 inc_layer(nat8 layer,float64 inc_mass)  modification_ { mass[layer] += inc_mass; return mass[layer]; }
...
#error check obsolete
   virtual float64 set_node
      (nat8  node,float64 new_mass,nat8  number_real_plus_extended_nodes
