...
,const CORN::date32 &today_raw //180417 const CORN::Date                   &today_
...
, stages                (sub_elements)
{}
//_2015-03-16___________________________________________________________________
bool Population_insect::restart_thermal_time_accumulation()       rectification_ //151210
{  degree_days_cum = 0;
   return true;
}
//_2015-12-10___________________________________________________________________
...
: CS::Simulation_element_abstract(today_raw/*180417 today_*/)
...
//_2015-06-15___________________________________________________________________
...
//_2016-01-20____________________________________________________terminate_all_/
...
//_2015-04-12_____________________________________Stage::matriculate_to_stage__/
...
{  nat32 stage_index = ((nat32)instar << 8) | stage;
   ...
   if (!provided_stage)
   {
      switch (stage)
      {
         case adult_preseason_stage   : provided_stage = new Adult_pre_season    (parameters.stage_development[adult_preseason_stage] ,parameters.adult_pre_season_mortality_rate_coef,parameters.oviposition_rate_coef,today_raw,*this,air_temperature_mean_daily,air_temperature_min_daily, air_temperature_by_hour,degree_days_cum); break;
         case ovum_stage              : provided_stage = new Ovum                (parameters.stage_development[ovum_stage]            ,parameters.ova_morality                                          ,today_raw,*this,air_temperature_mean_daily,air_temperature_by_hour/*,degree_days_cum*/); break;
         case larva_stage             : provided_stage = new Larva               (instar,parameters.larva_instar_development[instar]  ,parameters.larva_instar_mortality[instar]
                                                                                       ...
                                                                                       ,larvae_feeding_daily,today_raw,*this,air_temperature_mean_daily,air_temperature_by_hour/*,degree_days_cum*/); break;
         case pupa_stage              : provided_stage = new Pupa                (parameters.stage_development[pupa_stage]            ,parameters.pupa_mortality                                        ,today_raw,*this,air_temperature_mean_daily,air_temperature_by_hour/*,degree_days_cum*/); break;
         case adult_postseason_stage  : provided_stage = new Adult_post_season   (parameters.stage_development[adult_postseason_stage],parameters.adult_post_season_mortality_rate_coef                 ,today_raw,*this,air_temperature_mean_daily,air_temperature_min_daily,air_temperature_by_hour/*,degree_days_cum*/); break;
         #ifdef USE_DIAPAUSE_STAGE
         case adult_diapause_stage    : provided_stage = new Adult_diapause      (parameters.stage_development[adult_diapause_stage]    /*uses specialized mortality rate calculation*/                 ,today_raw,*this,air_temperature_mean_daily,air_temperature_min_daily,soil_temperature_by_hour/*,degree_days_cum*/); break;
         #endif
      }
...
//_2016-01-15___________________________________________________________________
...
//std::clog << "verify stages:" << std::endl;
   ...
   {
      if (CORN::is_approximately<float64>((double)stage->total_live(),0.0,0.0000001))
      {
...
//_2015-04-12____________________________________Population_insect::start_day__/
...
//_2016_02-11___________________________________________________________________
...
//_2016-01-19__________________________________________________________________/
float64 Population_insect::Adult_pre_season::calc_oviposition_rate_hourly(float64 Tmean_hour_Celcius)   const
{ // replaced with param_oviposition_rate_coef static const float64 C2 = 0.4; // C2 may be variable?
   ...
   return CORN::must_be_greater_or_equal_to<float64>(oviposition_rate,0.0);
}
...
float64 Population_insect::Adult::calc_mortality_rate_hourly(float64 Tmean_hourly_Celcius) const
{
   ...
   return CORN::must_be_greater_or_equal_to<float64>(mortality_rate,0.0);
...
// 2015-03-16______________________________Larvae::calc_mortality_rate_hourly__/
...
,const Air_temperature_average         &air_temperature_mean_daily_
,const CORN::Dynamic_array<float32>    &air_temperature_by_hour_)
: Stage(development_,today_raw,population_,air_temperature_mean_daily_,air_temperature_by_hour_)
, param_mortality (param_mortality_)
{}
//_2015-06-10________________________________________________Egg::constructor__/
...
,const Air_temperature_average      &air_temperature_mean_daily_
,const CORN::Dynamic_array<float32> &air_temperature_by_hour_)
: Stage(param_development_,today_raw,population_,air_temperature_mean_daily_,air_temperature_by_hour_)
, instar                      (instar_)
, param_mortality             (param_mortality_)
...
{}
//_2015-06-10_____________________________________________Larvae::constructor__/
Population_insect::Pupa::Pupa
(const Parameters_insect::Development    &development_
,const Parameters_insect::Mortality_pupa &param_mortality_
,const CORN::date32                 &today_raw //180417 ,const CORN::Date &_today
,const Population_insect            &population_
,const Air_temperature_average      &air_temperature_mean_daily_
,const CORN::Dynamic_array<float32> &air_temperature_by_hour_)
: Stage
   (development_,today_raw,population_
   ,air_temperature_mean_daily_,air_temperature_by_hour_)
,param_mortality     (param_mortality_)
{}
//_2015-06-10_______________________________________________Pupa::constructor__/
...
: Stage(development_,today_raw,population_,air_temperature_mean_daily_,temperature_by_hour_)
,param_mortality_rate_coef(param_mortality_rate_coef_)
,air_temperature_min_daily(air_temperature_min_daily_)
{}
//_2015-06-10___________________________________Adult_pre_season::constructor__/
...
: Adult(development_,param_mortality_rate_coef_,today_raw,population_
...
,const Air_temperature_minimum      &air_temperature_min_daily_
,const CORN::Dynamic_array<float32> &soil_temperature_by_hour_)
: Adult(development_,999.99,today_raw,population_,air_temperature_mean_daily_
,_air_temperature_min_daily
   ,soil_temperature_by_hour_)
{}
#endif
//_2015-12-10______________________________________Adult_diapause::constructor_/
...
{}
//_2015-06-10__________________________________Adult_post_season::constructor__/
...
//_2015-06-19_____________________________________________Egg::get_next_stage__/
...
//_2015-06-19__________________________________________Larvae::get_next_stage__/
...
//_2016-01-16___________________________________________________________________
#ifdef USE_DIAPAUSE_STAGE
...
//_2016-01-17___________________________________________________________________
#endif
