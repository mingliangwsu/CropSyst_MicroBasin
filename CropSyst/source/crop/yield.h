...
: public extends_ Yield_abstract
{
   ...
   CORN::Statistical_sample_cumulative<float32,float32>/*180408 Statistical_running_index*/  tuber_init_temperature_stress_stats;         //010726
      // was float32 could be float64
   CORN::Statistical_sample_cumulative<float32,float32>/*Statistical_running_index*/  tuber_growth_temperature_stress_stats;       //010726
      // was float32 could be float64
...
//______________________________________________________________________________
#ifdef OLD_ORCHARD
class Yield_orchard_fruit
: public implements_ CropSyst::Yield
{public:
   float64 &fruit_dry_biomass;
 public:
   inline Yield_orchard_fruit(float64 &fruit_dry_biomass_)
      // BCC compiler does like this: CropSyst::Yield()
      : fruit_dry_biomass(fruit_dry_biomass_)
      {}
   virtual float64 calculate(float64 canopy_biomass_kg_m2)         calculation_;
   //   { return 0; }  // DELETE THIS LINE (it is just temporary)
...
//_2017-02-21___________________________________________________________________
