...
const CORN::Date &Intercrop::ref_GAI_max_date()                           const { return predominant_crop->ret_GAI_max_date();} //180413
   #ifdef CROP_ORCHARD
...
RENDER_INSPECTORS_DEFINITION(Intercrop)
{
   ...
   const CS::Emanator &emanator =
      predominant_crop
      ? predominant_crop->render_inspectors(inspectors,context,instance_description/*170321RLN,statistic*/)
