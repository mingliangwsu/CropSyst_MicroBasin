...
//_2008-12-04___________________________________________________________________
Crop_orchard_fruit::Crop_orchard_fruit //180619 was Crop_CropSyst_orchard_fruit
...
,initial_fruit_growth_date    (0)//170525 ((Year)0,CORN::DOY(0),D_YMD,D_YYYY|D_Mmm|D_lead_zero,'/')         //030521
,veraison_date                (0)//170525 ((Year)0,CORN::DOY(0),D_YMD,D_YYYY|D_Mmm|D_lead_zero,'/')         //030521
,rapid_fruit_growth_date      (0)//170525 ((Year)0,CORN::DOY(0),D_YMD,D_YYYY|D_Mmm|D_lead_zero,'/')         //030521

,bud_break_date                     (0)//170525 ((Year)0,CORN::DOY(0),D_YMD,D_YYYY|D_Mmm|D_lead_zero,'/')   //081013
,chill_requirement_satisfied_date   (0)//170525 ((Year)0,CORN::DOY(0),D_YMD,D_YYYY|D_Mmm|D_lead_zero,'/')   //081013
...
bool Crop_orchard_fruit::initialize()
{
   ...
   initial_fruit_growth_date     .clear(); //180822 set_YD(Year(0),CORN::DOY(0));                     //030521
   veraison_date                 .clear(); //180822 set_YD(Year(0),CORN::DOY(0));                     //030521
   rapid_fruit_growth_date       .clear(); //180822 set_YD(Year(0),CORN::DOY(0));                     //030521
   bud_break_date                .clear(); //180822 set_YD(Year(0),CORN::DOY(0));                   //081013
   chill_requirement_satisfied_date.clear(); //180822 set_YD(Year(0),CORN::DOY(0));                //081013
   yield = new Crop_orchard_fruit::Yield(fruit_dry_biomass);                     //170221
   return true;
}
...
//_2007-11-20___________________________________________________________________
void Crop_orchard_fruit::setup_inactive_period_end_requirement(CORN::DOY doy)
...
float64 Crop_orchard_fruit::Yield::calculate(float64 canopy_biomass_kg_m2)  calculation_
...
void Crop_orchard_fruit::restart(float64 restart_biomass,float64 restart_GAI,bool use_clump_factor, bool after_dormancy)
...
//_2007-11-20___________________________________________________________________
void Crop_orchard_fruit::consider_inactive_period                       //020626
...
{  if (fruit_bud_break_requirement)                                              //021125
   { if (fruit_bud_break_requirement->satisfied
       ...
       { phenology.growth_stage = FGS_ACTIVE_GROWTH;                             //030523
         ...
         log_event("Bud break");
//abandoned         initiate_emergence();                                                   //180608
...
//______________________________________________________________________________
void Crop_orchard_fruit::senesce_at_dormancy()
...
//180622 #ifdef OLD_ORCHARD
   if ((parameters->crop_model_labeled.get() == CROPSYST_ORCHARD_MODEL)
      ...
      || (parameters->harvested_part_labeled.get() == fruit_part)
 #endif
      )
   {                                                                             //081103
...
//_2018-06-22_2008-12-04___________________________________________________________________
#endif
...
//_2018-06-12___________________________________________________________________
} // namespace CropSyst
