...
class Soil_nitrogen_interface;                                                   //050721
class Slope_saturated_vapor_pressure_plus_psychrometric_resistance;
namespace CropSyst
{
   //170220LML class Crop_complete;                                                          //031201
...
{protected:
 ...
 private:
   Soil_interface             *soil_properties;    // Optional. If not specified, we assum full water content (no limitations) 050721_
   Soil_nitrogen_interface    *soil_chemicals;     // Optional. If not specified, then nitrogen is not simulated 050721_
 protected:
 ...
 public: // State
   //160628 unused float64 Xattainable_top_growth;  // N adjusted                                 //151030
   ...
   mutable CORN::Statistical_sample_cumulative<float32,float32>/*180408 Statistical_running_index*/
      stress_factor_stats;                  //011117
//   mutable CORN::Statistical_sample_cumulative<float32,float32>stress_factor_stats; //160803
 ...
 public: // processing
   ...
   virtual Crop_mass_fate *render_N_fate(Biomass_fated_cause cause,float64 canopy_before,float64 root_before) rendition_;//131005
...
//NYI/*070321_*/    inline virtual float64 get_root_concentration_effete()   const { return root_concentration_effete; };
 ...
 public: // Accessors used for crop nitrogen parameter calibration.
   ...
   virtual float64 calc_leaf_stress_factor                                       //070224
      (Nitrogen_leaf_stress_mode calc_mode)                                const;//070224
