...
{  // Determine green canopy cover  // in VB is ActualCanopyCover
   ...
   //std::clog << "global_solar_rad_intercepted_total_canopy:" << global_solar_rad_intercepted_total_canopy
   //          << "\nglobal_solar_rad_intercepted_green_canopy:" << global_solar_rad_intercepted_green_canopy
   //          << std::endl;
