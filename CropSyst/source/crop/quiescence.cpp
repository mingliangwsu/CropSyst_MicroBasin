...
/*180601 Claudio says obsolete but dont delete yet
   ...
   inactive_days_remaining  =
      ...
      : quick_leave_inactive_period_valid_DOY -  inactive_period_start_DOY;
   //std::clog << " parameters.end_DOY:" << parameters.end_DOY
   //          << " inactive_days_remaining:" << inactive_days_remaining 
   //          << " quick_leave_inactive_period_valid_DOY:" << quick_leave_inactive_period_valid_DOY
   //          << " inactive_period_start_DOY:" << inactive_period_start_DOY
   //          << std::endl;
