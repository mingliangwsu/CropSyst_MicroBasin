...
// (For ET model types)
namespace CS {
   class Desired_variables;                                                      //170225
...
: public ET_Reference_FAO                                                        //011018
{
 ...
 public :
   ...
   /*180404 This is the ET_reference so just use the parameter value
 ...
 public: // ET calculation
   ...
   float64 calc_pot_ref_evapotranspiration_mm() const; // mutation_  //180822
   // This returns the daytime potET!!
 public: // Accessors
   /*180404 obsolete now just use get_mm()
