...
)
{
   ...
   alloc_ID = alloc_ID_;
   #ifdef NITROGEN
   const NO3_Profile *NO3 = 0;                                                   //180107
   const NH4_Profile *NH4 = 0;                                                   //180107
   const Chemical_balance_accumulators *NO3_ANNL_bal_accums = 0;                 //180107
   const Chemical_balance_accumulators *NH4_ANNL_bal_accums = 0;                 //180107
   #endif
   if (soil)                                                                     //180107
   {                                                                             //180107
      #ifdef NITROGEN
      Soil_chemicals_profile *soil_chemical = soil->chemicals;                   //180107
      if (soil_chemical)                                                         //180107
      {  NO3 = soil_chemical->NO3;                                               //180107
         NH4 = soil_chemical->NH4;                                               //180107
         NO3_ANNL_bal_accums = NO3->ANNL_bal_accums;                             //180107
         NH4_ANNL_bal_accums = NO3->ANNL_bal_accums;                             //180107
      }
      #endif
...
//180108 temp restored   #endif
   ...
   {
      //180108 temp restored#ifndef CS_INSPECTOR_VERSION
      if (NO3 && NO3_ANNL_bal_accums && NH4_ANNL_bal_accums)                   //140829_990409
      {
         N_inorganic_applied        =                                            //160323
              (NO3_ANNL_bal_accums->get_applied(true)
              +NH4_ANNL_bal_accums->get_applied(true));
         N_total_applied = N_inorganic_applied + N_organic_applied;              //160323
         N_leached        =
            #ifdef OFOOT_VERSION
              (NO3_ANNL_bal_accums->get_reported_leached(true)                  //140620
              +NH4_ANNL_bal_accums->get_reported_leached(true));                //140620
            #else
              (NO3_ANNL_bal_accums->get_reported_leached(true)                  //981230
              +NH4_ANNL_bal_accums->get_reported_leached(true));                //981230
            #endif
         N_uptake         =
              (NO3_ANNL_bal_accums->get_uptake(true)
              +NH4_ANNL_bal_accums->get_uptake(true));
      }
   ...
   // CS_INSPECTOR_VERSION
      ...
      denitrification_X = NO3_ANNL_bal_accums/*180107 soil.chemicals->NO3->ANNL_bal_accums*/->get_transformed_to(true);
      N_soil_profile
      = NO3_ANNL_bal_accums/*180107 soil.chemicals->NO3->ANNL_bal_accums*/->get_current_profile_content(true)
      + NH4_ANNL_bal_accums/*180107 soil.chemicals->NH4->ANNL_bal_accums*/->get_current_profile_content(true);      // Mineral N in the soil    (mineral profile N)  // this is only for luca
      //180108 temp restored      #ifndef CS_INSPECTOR_VERSION
