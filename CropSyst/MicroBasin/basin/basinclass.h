...
//160809         Weather_provider        weather_provider;
    ...
    double initial_soil_profile_mineral_N;                                       //170417LML
    double final_soil_profile_mineral_N;                                         //170417LML
    #ifdef MBVB_SNOW
    ...
    std::vector<double> hourlyBasinDrainage_DIN_kg;                              //(kgN/hour) 170417LML
...
//170404LML #endif
 ...
 public:
    ...
    double getHourlyBasinTotalDrainage_DIN();                                    //(kgN/hour) 170417LML
    //170501LML double getBasinTotalSoilInorganicNmass_kg();                                 //140910LML
    double getBasinTotalSoilChemicalMass_kg(const Solute solute);                //170501LML soil profile only, not including surface
    //170501LML double xgetBasinTotalSoilNO3_kg();
    //170501LML double xgetBasinTotalSoilNH4_kg();
    double getBasinSurfaceChemicalMass_kg(const Solute solute, bool reported = false);  //160317LML 170501LML added reported option
    #ifdef MBVB_SOIL
