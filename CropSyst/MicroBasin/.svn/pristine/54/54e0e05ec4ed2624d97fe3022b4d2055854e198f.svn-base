...
public:
    ...
    double Hourly_balance_leached_NH4_N;                                         //(kgN/m2) 170417LML
    double Hourly_balance_leached_NO3_N;                                         //(kgN/m2) 170417LML
    #ifndef CROPSYST_FD
    ...
    //170413LML_moved_out double Cumulative_Ammonium_Leaching;
   ...
   //160323RLN  #ifndef CROPSYST_CHEMICAL_TRANSPORT
    double Cumulative_Ammonium_Leaching;                                         //170413LML
...
public:
    ...
    double growth_season_N_uptake;                                               //(kgN/m2) 170207LML
    //double growth_season_N_runon;                                                //(kgN/m2) 170417LML inorganic N runon through overland and soil laterflow
    //double growth_season_N_runoff;                                               //(kgN/m2) 170417LML inorganic N runoff through overland and soil laterflow
    double Annual_N_uptake;                                                      //(kgN/m2) 170413LML
public:
    SoilProfileClass &SoilProfileRef;
    AllControlClass &ControlRef;
...
public:
   ...
   virtual float64 get_K_Theta
    ...
    virtual float64 get_ice_content_volumetric               ( nat8 layer) const { return Ice_Content[layer]; }  //hydrology->get_ice_content_volumetric(layer);} //170501LML need check why not using hydrology member.
